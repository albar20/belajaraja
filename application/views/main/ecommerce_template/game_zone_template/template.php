...
<head>
	...
	<!-- CSS Files -->
	<?php $this->carabiner->css("front_page/template/game_zone/css/bootstrap.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/game_zone/font-awesome/css/font-awesome.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/game_zone/css/style.css"); ?>
	<?php $this->carabiner->css("front_page/template/game_zone/css/responsive.css"); ?>
	<?php $this->carabiner->css("front_page/template/game_zone/css/magnific-popup.css"); ?>
...
<body>
	...
	<?php $this->carabiner->js("front_page/template/game_zone/js/jquery-1.11.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/game_zone/js/jquery-migrate-1.2.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/game_zone/js/bootstrap.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/game_zone/js/bootstrap-hover-dropdown.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/game_zone/js/jquery.magnific-popup.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/game_zone/js/jquery.magnific-popup.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/game_zone/js/custom.js","","false"); ?>
