					...
					<div class="panel panel-smart">
						...
						<div class="panel-body">
							...
							<div class="text-uppercase clearfix">
								<a class="btn btn-main pull-left col-md-6 col-sm-7 col-xs-12 xs500" href="<?php echo base_url()?>product" data-dismiss="modal">
									<span class="">Continue Shopping</span>
									<!-- <span class="visible-xs">Continue</span> -->
								</a>
								<a class="btn btn-main pull-right col-md-4 col-sm-4 col-xs-12 xs500" href="<?php echo base_url()?>cart/checkout">		
									Checkout
								</a>
							</div>
						</div>
