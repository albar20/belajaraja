						...
						<!-- Form Starts -->
							<form class="form-horizontal" role="form" method="post" action="<?php echo base_url()?>cart/saving_order">
								<div class="form-group">
									...
									<div class="col-sm-1">
										<button type="button" class="btn btn-main" data-toggle="modal" data-target="#modalFormAddress">
										  Add
										</button>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-offset-4 col-sm-8">
										<button type="submit" class="btn btn-main">Go To Payment</button>
									</div>
								</div>
		...
		<form class="form-horizontal" role="form" id="formAddress">
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-9">
					<button type="button" class="btn btn-main" id="buttonAddAddress" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Saving Address" onclick="saveAddress()">Save</button>
				</div>
			</div>
		</form>
      </div>
