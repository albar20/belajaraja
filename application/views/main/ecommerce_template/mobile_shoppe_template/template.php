...
<head>
	...
	<!-- CSS Files -->
	<?php $this->carabiner->css("front_page/template/mobile_shoppe/css/bootstrap.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/mobile_shoppe/font-awesome/css/font-awesome.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/mobile_shoppe/css/owl.carousel.css"); ?>
	<?php $this->carabiner->css("front_page/template/mobile_shoppe/css/style.css"); ?>
	<?php $this->carabiner->css("front_page/template/mobile_shoppe/css/responsive.css"); ?>
	<?php $this->carabiner->css("front_page/template/mobile_shoppe/css/magnific-popup.css"); ?>
...
<body>
	...
	<?php $this->carabiner->js("front_page/template/mobile_shoppe/js/jquery-1.11.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/mobile_shoppe/js/jquery-migrate-1.2.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/mobile_shoppe/js/bootstrap.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/mobile_shoppe/js/bootstrap-hover-dropdown.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/mobile_shoppe/js/jquery.magnific-popup.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/mobile_shoppe/js/owl.carousel.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/mobile_shoppe/js/custom.js","","false"); ?>
