			...
			<table class="table table-bordered">
				...
				?>
					<tr>
						...
						<td class="text-center">
							<div class="input-group btn-block btn-black">
						...
						<td class="text-center">
							<a href="<?php echo base_url()?>cart/update/<?php echo $item['rowid']?>" type="button" title="Update" class="btn btn-black tool-tip">
								<i class="fa fa-refresh"></i>
							</a>
							<a href="<?php echo base_url()?>cart/remove/<?php echo $item['rowid']?>" type="button" title="Remove" class="btn btn-black tool-tip">
					...
					<div class="panel panel-smart">
						...
						<div class="panel-body">
							...
							<div class="text-uppercase clearfix">
								<a class="btn btn-black pull-left" href="#" data-dismiss="modal">
									<span class="hidden-xs">Continue Shopping</span>
									<span class="visible-xs">Continue</span>
								</a>
								<a class="btn btn-black pull-right" href="#">		
									Checkout
								</a>
							</div>
						</div>
