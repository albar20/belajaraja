...
<head>
	...
	<!-- CSS Files -->
	<?php $this->carabiner->css("front_page/template/digi/css/bootstrap.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/digi/font-awesome/css/font-awesome.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/digi/css/owl.carousel.css"); ?>
	<?php $this->carabiner->css("front_page/template/digi/css/style.css"); ?>
	<?php $this->carabiner->css("front_page/template/digi/css/responsive.css"); ?>
	<?php $this->carabiner->css("front_page/template/digi/css/magnific-popup.css"); ?>
...
<body>
	...
	<!-- Header Wrap Starts -->
		<?php 	$this->uri->segment(1) == 'home' || $this->uri->segment(1) == '' 
			? $this->load->view($this->front_folder.$this->themes_folder_name.'/include/header-home') 
	...
	<?php $this->carabiner->js("front_page/template/digi/js/jquery-1.11.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/digi/js/jquery-migrate-1.2.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/digi/js/bootstrap.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/digi/js/bootstrap-hover-dropdown.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/digi/js/jquery.magnific-popup.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/digi/js/owl.carousel.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/digi/js/custom.js","","false"); ?>
