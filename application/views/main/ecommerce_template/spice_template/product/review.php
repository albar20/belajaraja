		...
		<div class="col-md-9">
			...
			if(isset($already_review)){
              ...
              echo '<div class="alert alert-info">
                ...
                <i class="fa fa-times"></i> ' . $already_review . '</div>';
			}	
            ...
            ?>
								...
								<form class="form-horizontal" id="ratingsForm" role="form" action="<?php echo base_url()?>product/add_review" method="post">									
								<div class="form-group">										
									<label for="review" class="col-sm-3 control-label">Overall Rating :</label>
									<div class="col-sm-9">																						
										<div id="rateOverall"></div><input type="hidden" name="nilai_rating" id="nilaiRating" value="<?php echo (isset($my_review) ? $my_review->row()->rate : 0) ?>" required>
									</div>										
								</div>
								<div class="form-group">										
									<label for="review" class="col-sm-3 control-label">Price Rating:</label>
									<div class="col-sm-9">																						
										<div id="ratePrice"></div><input type="hidden" name="price_rating" id="priceRating" value="<?php echo (isset($my_review) ? $my_review->row()->price : 0) ?>" required>
									</div>										
								</div>	
								<div class="form-group">										
									<label for="review" class="col-sm-3 control-label">Packaging Rating:</label>
									<div class="col-sm-9">																						
										<div id="ratePackaging"></div><input type="hidden" name="packaging_rating" id="packagingRating" value="<?php echo (isset($my_review) ? $my_review->row()->packaging : 0) ?>" required>
									</div>										
								</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<textarea name="review" class="form-control" rows="10" required><?php echo (isset($my_review) ? $my_review->row()->review : "") ?></textarea>
