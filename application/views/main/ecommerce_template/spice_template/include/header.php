			...
			<!-- Main Header Starts -->
				<div class="main-header">
					...
					<!-- Logo Starts -->
						<div class="col-md-9">
							<div id="logo">
								<a href="<?php echo base_url() ?>"><img style="border-radius:1000px;width:120px;" src="<?php echo base_url() ?>uploads/logo/thumb/<?php echo $this->setting->website_logo ?>" title="Fashion Shoppe" alt="Fashion Shoppe" class="img-responsive img-rounded" /></a>
							</div>
						</div>
					<!-- Logo Starts -->
					<!-- Search Starts -->
						...
						<!--<div class="col-md-3">
							<div id="cart" class="btn-group btn-block">
								<button type="button" data-toggle="dropdown" class="btn btn-block btn-lg dropdown-toggle">
									...
									<span id="cart-total"><?php echo $this->cart->total_items()?></span>
						...
						<div class="collapse navbar-collapse navbar-cat-collapse">
							<ul class="nav navbar-nav">
								...
								<?php foreach($category_product as $cp ): ?>
									...
									<?php else: ?>
										<li><a href="<?php echo base_url() ?><?php ($cp->category_product_name == "" ? "" : "product/category/".$scp->slug) ?>"><?php echo ($cp->category_product_name == "" ? "All" : $cp->category_product_name) ?></a></li>
									<?php endif; ?>
								<?php endforeach;?>
								<?php endif; ?>
							</ul>
