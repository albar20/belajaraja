...
<head>
	...
	<!-- CSS Files -->
	<?php $this->carabiner->css("front_page/template/spice/css/bootstrap.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/spice/font-awesome/css/font-awesome.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/spice/css/style.css"); ?>
	<?php $this->carabiner->css("front_page/template/spice/css/responsive.css"); ?>
	<?php $this->carabiner->css("front_page/template/spice/css/magnific-popup.css"); ?>
	...
	<?php $this->carabiner->css("front_page/css/custom-style.css"); ?>		<?php $this->carabiner->css("front_page/css/jquery.rateyo.min.css"); ?>
...
<body>
	...
	<?php $this->carabiner->js("front_page/template/spice/js/jquery-1.11.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/spice/js/jquery-migrate-1.2.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/spice/js/bootstrap.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/spice/js/bootstrap-hover-dropdown.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/spice/js/jquery.magnific-popup.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/spice/js/custom.js","","false"); ?>
	...
	<?php $this->carabiner->js("front_page/js/wishlist.js","","false"); ?>	<?php $this->carabiner->js("front_page/js/jquery.rateyo.min.js","","false"); ?>	
