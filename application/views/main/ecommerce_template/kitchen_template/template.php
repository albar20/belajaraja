...
<head>
	...
	<!-- CSS Files -->
	<?php $this->carabiner->css("front_page/template/kitchen/css/bootstrap.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/kitchen/font-awesome/css/font-awesome.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/kitchen/css/owl.carousel.css"); ?>
	<?php $this->carabiner->css("front_page/template/kitchen/css/style.css"); ?>
	<?php $this->carabiner->css("front_page/template/kitchen/css/responsive.css"); ?>
	<?php $this->carabiner->css("front_page/template/kitchen/css/magnific-popup.css"); ?>
...
<body>
	...
	<?php $this->carabiner->js("front_page/template/kitchen/js/jquery-1.11.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/kitchen/js/jquery-migrate-1.2.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/kitchen/js/bootstrap.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/kitchen/js/bootstrap-hover-dropdown.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/kitchen/js/jquery.magnific-popup.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/kitchen/js/owl.carousel.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/kitchen/js/custom.js","","false"); ?>
