...
<head>
	...
	<!-- CSS Files -->
	<?php $this->carabiner->css("front_page/template/jewellery/css/bootstrap.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/jewellery/font-awesome/css/font-awesome.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/jewellery/css/owl.carousel.css"); ?>
	<?php $this->carabiner->css("front_page/template/jewellery/css/style.css"); ?>
	<?php $this->carabiner->css("front_page/template/jewellery/css/responsive.css"); ?>
	<?php $this->carabiner->css("front_page/template/jewellery/css/magnific-popup.css"); ?>
...
<body>
	...
	<?php $this->carabiner->js("front_page/template/jewellery/js/jquery-1.11.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/jewellery/js/jquery-migrate-1.2.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/jewellery/js/bootstrap.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/jewellery/js/bootstrap-hover-dropdown.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/jewellery/js/jquery.magnific-popup.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/jewellery/js/owl.carousel.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/jewellery/js/custom.js","","false"); ?>
