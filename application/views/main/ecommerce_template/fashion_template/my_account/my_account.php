...
<div class="main-container inner container my_account_wrapper">
    <div class="row">   
        <?php 
        /*=====================================================
            2.  SIDEBAR LEFT
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                <div class="table-primary" id="tooltips-demo">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <br/>
                        <div class="col-md-5">
                            <a class="btn btn-black" href="<?php echo base_url() ?>my_account/edit_customer/<?php echo $cs[0]['customer_id'] ?>">Edit</a>
                        </div> 
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-sm-10 col-xs-12 my_account">
                    ...
                    <?php 
                        ...
                        <div class="<?php echo $row_type; ?>">
                            <div class="col-md-10 col-sm-10 col-xs-8">
                                ...
                                <br/>   
                                <span>
                                    <a href="#tambah_alamat_form" id="<?php echo $ca->customer_address_id ?>" 
                                        class="btn btn-black ubah_alamat_baru_button">Edit</a>
                                </span>
                                <?php if( $x != 0 ): ?>
                                    <span><a href="<?php echo base_url() ?>my_account/hapus_alamat/<?php echo $ca->customer_address_id ?>" class="btn btn-black">Delete</a></span>
                                <?php endif; ?>  
                            </div> 
                            <div class="col-md-2 col-sm-2 col-xs-4">
                                <br/>
                    ...
                    <div class="col-md-6 col-sm-4 col-xs-12">
                        <input type="button" id="show_tambah_alamat_form" value="Add New Address" class="btn btn-black" />
                    </div> 
                </div> 
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 tambah_alamat_form"  style="<?php echo $display_style; ?>" >
                ...
                <div>
                    ...
                    <div class="col-md-4 col-sm-8 col-xs-12">
                        <select class="form-control" id="province_id" name="province_id" required="required" onclick="getCitys(this.value)" >
                            <?php foreach( $province as $pr ): ?>
                                <option value="<?php echo $pr['province_id'] ?>"
                                    <?php echo set_select('province_id', $pr['province_id'] , isset($default['province_id']) && $default['province_id'] == $pr['province_id'] ? TRUE : FALSE); ?>
                                ><?php echo $pr['province'] ?></option>
                            <?php endforeach;?>
                        </select>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <input type="submit" class="btn btn-black tambah_alamat_baru" name="" id="" value="Save" />
                            <div class="clear"></div>                 
                            <br/>
                        </div>
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <input type="button" class="btn btn-black cancel_tambah_alamat" name="" id="" value="Cancel" />
                        </div>
