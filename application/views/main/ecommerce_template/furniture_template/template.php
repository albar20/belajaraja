...
<head>
	...
	<!-- CSS Files -->
	<?php $this->carabiner->css("front_page/template/furniture/css/bootstrap.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/furniture/font-awesome/css/font-awesome.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/furniture/css/owl.carousel.css"); ?>
	<?php $this->carabiner->css("front_page/template/furniture/css/style.css"); ?>
	<?php $this->carabiner->css("front_page/template/furniture/css/responsive.css"); ?>
	<?php $this->carabiner->css("front_page/template/furniture/css/magnific-popup.css"); ?>
...
<body>
	...
	<?php $this->carabiner->js("front_page/template/furniture/js/jquery-1.11.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/furniture/js/jquery-migrate-1.2.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/furniture/js/bootstrap.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/furniture/js/bootstrap-hover-dropdown.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/furniture/js/jquery.magnific-popup.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/furniture/js/owl.carousel.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/furniture/js/custom.js","","false"); ?>
