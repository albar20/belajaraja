			...
			<table class="table table-bordered">
				...
				?>
					<tr>
						...
						<td class="text-center">
							<div class="input-group btn-block btn-brown">
						...
						<td class="text-center">
							<a href="<?php echo base_url()?>cart/update/<?php echo $item['rowid']?>" type="button" title="Update" class="btn btn-brown tool-tip">
								<i class="fa fa-refresh"></i>
							</a>
							<a href="<?php echo base_url()?>cart/remove/<?php echo $item['rowid']?>" type="button" title="Remove" class="btn btn-brown tool-tip">
					...
					<div class="panel panel-smart">
						...
						<div class="panel-body">
							...
							<div class="text-uppercase clearfix">
								<a class="btn btn-brown pull-left" href="#" data-dismiss="modal">
									<span class="hidden-xs">Continue Shopping</span>
									<span class="visible-xs">Continue</span>
								</a>
								<a class="btn btn-brown pull-right" href="#">		
									Checkout
								</a>
							</div>
						</div>
