				...
				<div class="col-sm-8 product-details">
					...
					<!-- Product Name Starts -->
						<div class="row">
							...
							<!-- Price Starts -->
								<div class="price">
									<span class="price-head">Rate :</span>
									<span class="price-new"><i class="fa fa-star"></i>
							...
							<div class="col-sm-4 text-center">
								<h1><span class="rating">4.2</span></h1>
							</div>
					<!-- Price Ends -->
						</div>
						<hr>
						<div class="row">
							<div class="col-md-12 text-center">
								<a class="btn btn-brown btn-lg" href="<?php echo base_url()?>product/review/<?php echo $product_list->product_id?>">WRITE REVIEW</a>
							</div>
						</div>
							...
							<div class="col-xs-12">
								...
								<div class="product-col list clearfix">
									...
									<div class="caption">
										...
										<h4><a href="product-full.html">Jean Doe</a></h4>
