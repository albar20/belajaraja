...
<head>
	...
	<!-- CSS Files -->
	<?php $this->carabiner->css("front_page/template/shoppe/css/bootstrap.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/shoppe/font-awesome/css/font-awesome.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/shoppe/css/style.css"); ?>
	<?php $this->carabiner->css("front_page/template/shoppe/css/responsive.css"); ?>
	<?php $this->carabiner->css("front_page/template/shoppe/css/magnific-popup.css"); ?>
...
<body>
	...
	<?php $this->carabiner->js("front_page/template/shoppe/js/jquery-1.11.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/shoppe/js/jquery-migrate-1.2.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/shoppe/js/bootstrap.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/shoppe/js/bootstrap-hover-dropdown.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/shoppe/js/jquery.magnific-popup.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/shoppe/js/jquery.magnific-popup.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/shoppe/js/custom.js","","false"); ?>
