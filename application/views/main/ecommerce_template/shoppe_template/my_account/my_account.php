            ...
            <div class="row">
                <div class="table-primary" id="tooltips-demo">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <br/>
                        <div class="col-md-5">
                            <a class="btn btn-brown" href="<?php echo base_url() ?>my_account/edit_customer/<?php echo $cs[0]['customer_id'] ?>">Edit</a>
                        </div> 
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-sm-10 col-xs-12 my_account">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-8">
                                ...
                                <span>
                                    <a href="#tambah_alamat_form" id="<?php echo $ca->customer_address_id ?>" 
                                        class="btn btn-brown ubah_alamat_baru_button">Edit</a>
                                </span>
                                <?php if( $x != 0 ): ?>
                                    <span><a href="<?php echo base_url() ?>my_account/hapus_alamat/<?php echo $ca->customer_address_id ?>" class="btn btn-brown">Delete</a></span>
                                <?php endif; ?>  
                            </div> 
                            <div class="col-md-2 col-sm-2 col-xs-4">
                                <br/>
                    ...
                    <div class="col-md-6 col-sm-4 col-xs-12">
                        <input type="button" id="show_tambah_alamat_form" value="Add New Address" class="btn btn-brown" />
                    </div> 
                </div> 
                ...
                <div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <input type="submit" class="btn btn-brown tambah_alamat_baru" name="" id="" value="Save" />
                            <div class="clear"></div>                 
                            <br/>
                        </div>
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <input type="button" class="btn btn-brown cancel_tambah_alamat" name="" id="" value="Cancel" />
                        </div>
