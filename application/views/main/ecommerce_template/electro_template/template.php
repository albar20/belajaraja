...
<head>
	...
	<!-- CSS Files -->
	<?php $this->carabiner->css("front_page/template/electro/css/bootstrap.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/electro/font-awesome/css/font-awesome.min.css"); ?>
	<?php $this->carabiner->css("front_page/template/electro/css/owl.carousel.css"); ?>
	<?php $this->carabiner->css("front_page/template/electro/css/style.css"); ?>
	<?php $this->carabiner->css("front_page/template/electro/css/responsive.css"); ?>
	<?php $this->carabiner->css("front_page/template/electro/css/magnific-popup.css"); ?>
...
<body>
	...
	<?php $this->carabiner->js("front_page/template/electro/js/jquery-1.11.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/electro/js/jquery-migrate-1.2.1.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/electro/js/bootstrap.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/electro/js/bootstrap-hover-dropdown.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/electro/js/jquery.magnific-popup.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/electro/js/owl.carousel.min.js","","false"); ?>
	<?php $this->carabiner->js("front_page/template/electro/js/custom.js","","false"); ?>
