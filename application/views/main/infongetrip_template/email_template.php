...
<center class="wrapper" style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#f3f2f0;">
  ...
  <![endif]-->
                      ...
                      <div>
                          ...
                          <tbody>
                            <tr>
                              <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                  <tr>
                                    <td width="75" height="40" align="center" bgcolor="#262626" style="-moz-border-radius:10px; -webkit-border-radius:10px; border-radius: 10px;"><font style="color:#ffffff; font-size:16px; text-align:center; font-family: Verdana, Geneva, sans-serif"><strong>Jun</strong></font></td>
                                  </tr>
                                </table></td>
                            </tr>
                          </tbody>
                        ...
                        <br />
                        <br />
                        <p style="color:#ffffff; font-size:60px; text-align:center; font-family: Verdana, Geneva, sans-serif">InfoNgetrip.Com
                          </p>
                        <br />
                        <br />
                        <p style="color:#ffffff; font-size:25px; text-align:center; font-family: Verdana, Geneva, sans-serif; line-height:22px ">lorem ipsum 40% </p>
                      </div>
