...
<!-- 							<div class="form_popup from_register" tabindex="-1">
	...
	<div class="site wrapper-content">
		<div class="home-content" role="main">
			<div class="wrapper-bg-video">
				<video poster="<?php echo base_url()?>assets/front_page/template/infongetrip/images/video_slider.jpg" playsinline autoplay muted loop>
			...
			<div class="padding-top-6x padding-bottom-6x bg__shadow section-background" style="background-image:url(http://placehold.it/1600x700)">
				<div class="container">
					...
					<div class="row wrapper-tours-slider">
						<div class="tours-type-slider list_content" data-dots="true" data-nav="true" data-responsive='{"0":{"items":1}, "480":{"items":2}, "768":{"items":2}, "992":{"items":3}, "1200":{"items":4}}'>
							<?php foreach($best_tour->result() as $row) { ?>
							<div class="item-tour">
								<div class="item_border">
									<div class="item_content">
										<div class="post_images">
											<a href="<?php echo base_url()?>tour/detail/<?php echo $row->slug?>" class="travel_tour-LoopProduct-link">
												<img src="<?php echo base_url()?>uploads/wisata/<?php echo $row->slug?>/thumb/thumb_<?php echo $row->picture_1?>" alt="" title="">
											</a>
									...
									<div class="read_more">
										...
										<a href="<?php echo base_url()?>tour/detail/<?php echo $row->slug?>" class="read_more_button">VIEW MORE
				...
				<div class="container">
					...
					<div class="wrapper-tours-slider wrapper-tours-type-slider">
						<div class="tours-type-slider" data-dots="true" data-nav="true" data-responsive='{"0":{"items":1}, "480":{"items":2}, "768":{"items":3}, "992":{"items":4}, "1200":{"items":5}}'>
							...
							<div class="tours_type_item">
								<a href="tours.html" class="tours-type__item__image">
									<img src="http://placehold.it/250x250" alt="USA">
								</a>
								<div class="content-item">
			...
			<div class="section-white padding-top-6x padding-bottom-6x">
				<div class="container">
					<div class="shortcode_title title-center title-decoration-bottom-center">
						<h3 class="title_primary">New Tours</h3><span class="line_after_title"></span>
					</div>
					<div class="row wrapper-tours-slider">
						<div class="tours-type-slider list_content" data-dots="true" data-nav="true" data-responsive='{"0":{"items":1}, "480":{"items":2}, "768":{"items":3}, "992":{"items":3}, "1200":{"items":3}}'>
							<?php foreach($new_tour->result() as $row) { ?>
							<div class="item-tour">
								<div class="item_border">
									<div class="item_content">
										<div class="post_images">
			...
			<div class="bg__shadow padding-top-6x padding-bottom-6x section-background" style="background-image:url(http://placehold.it/1600x700)">
				<div class="container">
					<div class="row">
								...
								<div class="tours-type-slider" data-autoplay="true" data-dots="true" data-nav="false" data-responsive='{"0":{"items":1}, "480":{"items":1}, "768":{"items":1}, "992":{"items":1}, "1200":{"items":1}}'>
									<div class="tour-reviews-item">
										<div class="reviews-item-info">
											<img alt="" src="" class="avatar avatar-95 photo" height="90" width="90">
							...
							<div class="row">
								<div class="post_list_content_unit col-sm-6">
									<div class="feature-image">
										<a href="single.html" class="entry-thumbnail">
											<img width="370" height="260" src="" alt="">
										</a>
									</div>
	...
	<!--<div class="bg__shadow wrapper-subscribe" style="background-image: url()">
...
<?php $this->carabiner->js("front_page/template/infongetrip/js/owl.carousel.min.js","","false"); ?>
<?php $this->carabiner->js("front_page/template/infongetrip/js/jquery.mb-comingsoon.min.js","","false"); ?>
