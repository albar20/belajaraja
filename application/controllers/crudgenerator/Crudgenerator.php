...
class crudgenerator extends CI_Controller {
	...
	public function index()
	{
		...
		$data['daftar_tabel']	= $this->db->query("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='$database'");
	
		$data['page']			= 'generator/page_form';
	...
	function process()
	{
		...
		$basic['controller_name']		= $_POST['nama_controller'];
		
		$basic['otorisasi']				= ($_POST['otorisasi'] == "ya" ? $_POST['code_otorisasi'] : "");
		...
		$this->crud_generator->create_controller($basic,$field,'admin');
		$this->crud_generator->create_views_list($basic,$field,'admin');
		$this->crud_generator->create_views_form($basic,$field,'admin');
