...
INSERT INTO `location_districts` (`id`, `regency_id`, `name`) VALUES
...
ALTER TABLE `location_districts`
  ADD CONSTRAINT `districts_regency_id_foreign` FOREIGN KEY (`regency_id`) REFERENCES `location_city` (`id`);
